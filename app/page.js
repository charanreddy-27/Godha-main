...
export default function Home() {
  ...
  const fetchFeaturedProducts = async () => {
    try {
      ...
      setFeaturedProducts(products.length > 0 ? products : getDemoProducts({ limit: 9 }));
    } catch (error) {
      setFeaturedProducts(getDemoProducts({ limit: 9 }));
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="space-y-6 lg:pr-4">
              ...
              <p className="text-base md:text-lg text-royal-500 leading-relaxed max-w-lg">
                Discover handcrafted sarees, ethnic wear, and dresses that celebrate India&#39;s rich textile heritage with contemporary grace.
              </p>

              <div className="flex flex-wrap gap-3 pt-2">
                <Link href="/sarees">
                  <Button size="lg" className="bg-royal-900 hover:bg-royal-800 text-white px-7 py-5 rounded-full text-sm font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group">
                    Explore Sarees
                    <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-0.5 transition-transform" />
                  </Button>
                </Link>
                <Link href="/ethnic">
                  <Button size="lg" variant="outline" className="border-2 border-royal-800 text-royal-800 hover:bg-royal-800 hover:text-white px-7 py-5 rounded-full text-sm font-semibold transition-all duration-300">
                    View Ethnic Wear
                  </Button>
                </Link>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-6 border-t border-royal-100/50">
                <div>
                  <div className="text-2xl font-bold text-royal-900 font-display">500+</div>
                  <div className="text-xs text-royal-500 mt-1 font-medium">Unique Designs</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-gold-600 font-display">50K+</div>
                  <div className="text-xs text-royal-500 mt-1 font-medium">Happy Customers</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-teal-600 font-display">4.9★</div>
                  <div className="text-xs text-royal-500 mt-1 font-medium">Avg. Rating</div>
                </div>
              </div>
            </div>
              ...
              <div className="absolute inset-0 grid grid-cols-5 grid-rows-6 gap-3">
                ...
                <div className="col-span-3 row-span-6 relative rounded-2xl overflow-hidden shadow-xl group">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    <h3 className="text-xl font-display font-bold text-white">Silk Sarees</h3>
                    <p className="text-ivory-200 text-sm mt-0.5">Premium handwoven</p>
                  </div>
                </div>
                ...
                <div className="col-span-2 row-span-3 relative rounded-2xl overflow-hidden shadow-lg group">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <h4 className="text-base font-semibold text-white">Ethnic Wear</h4>
                  </div>
                </div>
                ...
                <div className="col-span-2 row-span-3 relative rounded-2xl overflow-hidden shadow-lg group">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <h4 className="text-base font-semibold text-white">Dresses</h4>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-white py-10 border-y border-royal-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              { icon: ShieldCheck, label: '100% Authentic', sub: 'Guaranteed Quality', color: 'text-royal-600' },
              { icon: Truck, label: 'Free Shipping', sub: 'Orders above ₹2,999', color: 'text-teal-600' },
              { icon: RotateCcw, label: 'Easy Returns', sub: '7-day return policy', color: 'text-gold-600' },
              { icon: Star, label: 'Top Rated', sub: '4.9/5 customer rating', color: 'text-lotus-600' },
              ...
              <div key={label} className="flex items-center gap-3 group">
                ...
                <div>
                  <div className="text-sm font-semibold text-royal-900">{label}</div>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            ...
            <Link href="/ethnic" className="group md:col-span-2 md:row-span-2">
              <div className="relative h-[300px] md:h-full min-h-[420px] rounded-2xl overflow-hidden">
                <Image src="/images/demo-ethnic.svg" alt="Ethnic wear" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent" />
                <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end">
                  <span className="text-gold-300 text-xs font-semibold uppercase tracking-widest mb-2">Trending</span>
                  <h3 className="font-display text-2xl md:text-3xl font-bold text-white mb-2">Ethnic Wear</h3>
                  <p className="text-ivory-200 text-sm mb-4 max-w-sm">Kurtis, 2-Piece & 3-Piece Sets, Lehangas – for every occasion</p>
            ...
            <Link href="/sarees" className="group">
              <div className="relative h-[200px] md:h-full min-h-[200px] rounded-2xl overflow-hidden">
                <Image src="/images/demo-hero-main.svg" alt="Saree collection" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/55 via-black/15 to-transparent" />
                <div className="absolute inset-0 p-5 flex flex-col justify-end">
                  <h3 className="font-display text-xl font-bold text-white mb-1">Sarees</h3>
                  <p className="text-ivory-200 text-xs mb-3">Kanchivaram, Kalamkari & more</p>
            ...
            <Link href="/dresses" className="group">
              <div className="relative h-[200px] md:h-full min-h-[200px] rounded-2xl overflow-hidden">
                <Image src="/images/demo-dresses.svg" alt="Dress collection" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/55 via-black/15 to-transparent" />
                <div className="absolute inset-0 p-5 flex flex-col justify-end">
                  <h3 className="font-display text-xl font-bold text-white mb-1">Dresses</h3>
                  <p className="text-ivory-200 text-xs mb-3">Frocks & Indo-Western styles</p>
                  <span className="inline-flex items-center text-white text-sm font-medium group-hover:gap-1.5 transition-all">
                    Explore <ArrowRight className="ml-1 h-3.5 w-3.5" />
                  </span>
                </div>
        ...
        <section className="py-16 md:py-20 bg-ivory-50/50">
          <div className="container mx-auto px-4">
            <div className="flex items-end justify-between mb-10">
              ...
              <Link href="/ethnic">
                <Button variant="ghost" className="text-royal-600 hover:text-royal-900 font-medium text-sm">
