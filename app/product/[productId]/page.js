...
import { Loader2, ShoppingCart, ChevronRight, Star, Truck, ShieldCheck, ArrowLeft } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-2 text-sm overflow-x-auto whitespace-nowrap scrollbar-hide">
            ...
            <Link
              ...
              className="text-royal-500 hover:text-gold-600 font-medium transition-colors"
            >
              {product.category}
            </Link>
            <ChevronRight className="h-3 w-3 text-royal-300 flex-shrink-0" />
            ...
            <ChevronRight className="h-3 w-3 text-royal-300 flex-shrink-0" />
            <span className="text-royal-900 font-bold">
              {product.name}
            </span>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            <div className="flex flex-col-reverse lg:flex-row gap-4">
                ...
                <div className="flex lg:flex-col gap-3 overflow-x-auto lg:overflow-y-auto lg:h-[600px] scrollbar-hide py-1">
                  {product.images.map((img, index) => (
                    <button
                      ...
                      className={`flex-shrink-0 w-20 h-24 rounded-lg overflow-hidden border-2 transition-all duration-300 ${selectedImage === index
              ...
              <div className="flex-1 aspect-[3/4] lg:h-[600px] bg-white rounded-2xl overflow-hidden shadow-luxury border border-royal-50 relative group">
                ...
                {/* Zoom Hints/Badges could go here */}
          ...
          <div className="lg:col-span-5 space-y-8 sticky top-32">
            <div>
              <h1 className="font-display text-3xl md:text-5xl font-bold mb-4 text-royal-900 leading-tight">
                {product.name}
              </h1>
              ...
              <div className="flex items-baseline gap-4 mb-2">
                ...
                <span className="text-lg text-royal-400 line-through decoration-royal-400/50 decoration-2">
            ...
            {product.sizes && product.sizes.length > 0 && (
              <div>
                <div className="flex justify-between items-center mb-3">
                  ...
                  <button className="text-xs text-gold-600 hover:text-gold-700 underline underline-offset-4 decoration-gold-300">Size Chart</button>
                </div>
            ...
            <div className="pt-6 space-y-4">
              {product.stock > 0 ? (
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Button className="col-span-1 bg-gold-500 hover:bg-gold-600 text-royal-900 rounded-lg py-7 text-lg font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 border-none">
                    Buy Now
                  </Button>
                </div>
              ) : (
                <Button disabled className="w-full bg-gray-200 text-gray-500 rounded-lg py-6 cursor-not-allowed" size="lg">
                  Out of Stock
                </Button>
              )}
            ...
            {product.description && (
              <div className="pt-6 border-t border-royal-100">
                ...
                <p className="text-royal-600 leading-relaxed text-sm">
                  {product.description}
                </p>
              </div>
            )}
