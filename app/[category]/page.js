...
export default function CategoryPage() {
    ...
    return (
      <div className="min-h-screen bg-ivory-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-royal-900 hover:bg-royal-800 transition-colors">
            Return to Home
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-ivory-50">
      ...
      {/* Subcategories - Premium Design */}
      <div className="sticky top-[80px] md:top-[96px] z-40 bg-white/80 backdrop-blur-md border-b border-royal-100 shadow-sm transition-all">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-wrap items-center gap-3">
            <span className="text-xs font-bold text-royal-400 uppercase tracking-widest mr-2 flex items-center gap-2">
