...
export default function CheckoutPage() {
  ...
  // Redirects must run only on the client to avoid SSR location errors
  useEffect(() => {
              ...
              <Card className="mb-6 border border-royal-100 shadow-lg bg-white">
                ...
                <CardContent className="space-y-4 p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-semibold mb-2 block text-royal-900">
                        Full Name *
                      </label>
                      <Input
                        name="fullName"
                  ...
                  <div>
                    <label className="text-sm font-medium mb-1 block text-royal-900">
                      Address *
                    </label>
                    <Input
                      name="address"
