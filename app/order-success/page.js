    ...
    <div className="container mx-auto px-4 py-20">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/">
            <Button size="lg" className="bg-royal-900 hover:bg-royal-800 text-white w-full sm:w-auto px-8 transition-colors">
              Continue Shopping
            </Button>
          </Link>
          <Link href="/admin">
            <Button variant="outline" size="lg" className="border-royal-200 text-royal-900 hover:bg-gold-50 w-full sm:w-auto px-8 transition-colors">
