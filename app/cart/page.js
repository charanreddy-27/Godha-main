              ...
              <CardContent className="p-6">
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-2xl font-bold bg-gradient-to-r from-royal-900 to-royal-700 bg-clip-text text-transparent">
            ...
            <CardContent className="p-8 bg-gradient-to-br from-white via-ivory-50/30 to-gold-50/20">
              ...
              <div className="space-y-5 mb-8">
                ...
                <div className="border-t-2 border-gold-200 pt-5 flex justify-between items-center">
                  ...
                  <span className="font-bold text-3xl bg-gradient-to-r from-royal-900 to-royal-700 bg-clip-text text-transparent">
                    ₹{getTotalPrice().toLocaleString('en-IN')}
                  </span>
                </div>
              </div>
