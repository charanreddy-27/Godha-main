  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ivory-50 via-white to-gold-50/30 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.03]">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-royal-900 to-teal-900 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-gold-600 to-lotus-600 rounded-full blur-3xl" />
      </div>
      ...
      <Card className="w-full max-w-md shadow-2xl border border-royal-100 relative z-10 bg-white/95 backdrop-blur-sm">
        <CardHeader className="text-center pb-8">
          ...
          <img src="/images/godha-logo.png" alt="Godha Collections" className="h-24 w-auto mx-auto mb-4" />
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-royal-900 hover:bg-royal-800" disabled={loading}>
                  {loading ? (
                    <>
