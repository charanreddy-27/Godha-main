        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <Link href="/">
              <Button
                size="lg"
                className="bg-royal-900 hover:bg-royal-800 text-white px-10 py-6 rounded-full text-base font-semibold shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                Start Shopping
              </Button>
            </Link>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-royal-600 mb-3 flex items-center gap-2">
                        <span className="px-2 py-0.5 rounded-full bg-royal-100 text-royal-700 font-medium">
                          {item.category}
                        </span>
                        <span className="text-royal-400">&bull;</span>
                        <span className="text-royal-600">{item.subCategory}</span>
                      </p>
                      <p className="text-xl font-bold text-royal-900">₹{item.price.toLocaleString('en-IN')}</p>
                    </div>
                    ...
                    <div className="flex flex-col items-end justify-between">
                      ...
                      <div className="flex items-center gap-1 border-2 border-royal-200 rounded-xl overflow-hidden">
                        ...
                        <span className="w-12 text-center font-bold text-royal-900">{item.quantity}</span>
                        <button
                          onClick={() => updateQuantity(item.id, item.quantity + 1)}
                          className="p-3 hover:bg-royal-50 transition-colors duration-300 text-royal-700"
                        >
              ...
              <CardContent className="p-8 bg-gradient-to-br from-white via-ivory-50/30 to-gold-50/20">
                ...
                <div className="space-y-5 mb-8">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-royal-900 text-lg">₹{getTotalPrice().toLocaleString('en-IN')}</span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="border-t-2 border-gold-200 pt-5 flex justify-between items-center">
                    ...
                    <span className="font-bold text-2xl text-royal-900">₹{getTotalPrice().toLocaleString('en-IN')}</span>
                  </div>
                </div>

                <Link href="/checkout">
                  <Button
                    className="w-full bg-royal-900 hover:bg-royal-800 text-white py-6 rounded-xl text-base font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 mb-4"
                    size="lg"
                  >
                    Proceed to Checkout
                  </Button>
                ...
                <Link href="/">
                  <Button
                    variant="outline"
                    className="w-full border-2 border-royal-800 text-royal-800 hover:bg-royal-50 py-6 rounded-xl text-base font-semibold transition-all duration-300"
                  >
                    Continue Shopping
                  </Button>
                </Link>
